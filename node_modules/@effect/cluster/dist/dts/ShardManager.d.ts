...
declare const Rpcs_base: RpcGroup.RpcGroup<Rpc.Rpc<"Register", Schema.Struct<{
    ...
    address: typeof RunnerAddress;
}>, typeof Schema.Void, typeof Schema.Never, never> | Rpc.Rpc<"GetAssignments", typeof Schema.Void, Schema.Array$<Schema.Tuple2<typeof ShardId, Schema.Option<typeof RunnerAddress>>>, typeof Schema.Never, never> | Rpc.Rpc<"ShardingEvents", typeof Schema.Void, import("@effect/rpc/RpcSchema").Stream<Schema.Union<[Schema.TaggedStruct<"StreamStarted", {}>, Schema.TaggedStruct<"ShardsAssigned", {
    address: typeof RunnerAddress;
    shards: Schema.Array$<typeof ShardId>;
}>, Schema.TaggedStruct<"ShardsUnassigned", {
    address: typeof RunnerAddress;
    ...
    address: typeof RunnerAddress;
}>]>, typeof Schema.Never>, typeof Schema.Never, never> | Rpc.Rpc<"GetTime", typeof Schema.Void, typeof Schema.Number, typeof Schema.Never, never>>;
/**
