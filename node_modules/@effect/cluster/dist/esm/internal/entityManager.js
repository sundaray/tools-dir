            ...
            case "Exit":
              {
                ...
                // interrupt.
                if (storageEnabled && Context.get(request.rpc.annotations, Persisted) && Exit.isInterrupted(response.exit) && (isShuttingDown || Context.get(request.rpc.annotations, Uninterruptible))) {
                  return Effect.void;
                }
