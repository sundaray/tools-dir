...
const make = exports.make = /*#__PURE__*/Effect.fnUntraced(function* (entity, buildHandlers, options) {
  ...
  const entities = yield* _resourceMap.ResourceMap.make(Effect.fnUntraced(function* (address) {
            ...
            case "Exit":
              {
                ...
                // interrupt.
                if (storageEnabled && Context.get(request.rpc.annotations, _ClusterSchema.Persisted) && Exit.isInterrupted(response.exit) && (isShuttingDown || Context.get(request.rpc.annotations, _ClusterSchema.Uninterruptible))) {
                  return Effect.void;
                }
    ...
    function onDefect(cause) {
      ...
      return Effect.logError("Defect in entity, restarting", cause).pipe(Effect.andThen(Effect.ignore(retryDriver.next(void 0))), Effect.andThen(effect), Effect.annotateLogs({
