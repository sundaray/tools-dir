    ...
    clients.set(id, {
      write: response => {
        try {
          ...
          return !includesFraming ? mailbox.offer((0, _RpcMessage.ResponseDefectEncoded)(cause)) : offer(parser.encode((0, _RpcMessage.ResponseDefectEncoded)(cause)));
        }
      },
      end: mailbox.end
    });
