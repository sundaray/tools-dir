...
export type PartialEffectful<A extends object> = Types.Simplify<{
    [K in keyof A as A[K] extends Effect.Effect<any, any, any> | ((...args: any) => Effect.Effect<any, any, any>) ? K : never]?: A[K];
} & {
    [K in keyof A as A[K] extends Effect.Effect<any, any, any> | ((...args: any) => Effect.Effect<any, any, any>) ? never : K]: A[K];
}>;
/**
